...
TEST(Validation, FailConditions) {
  ...
  EXPECT_FALSE(matcher.IsValid("PASjf!!4N"))
      << "at least two different special symbols";
  EXPECT_FALSE(matcher.IsValid("rrtG3FG!Tr^e"))
